...
CREATE TABLE Users (id UUID DEFAULT uuid_generate_v4() ,username VARCHAR(255) NOT NULL,password VARCHAR(255) NOT NULL,access_token VARCHAR(255),refresh_token VARCHAR(255), PRIMARY KEY(id));
